...
Client.prototype.addTorrent = function(url, downloadPathOverride) {
  var torrent = new Torrent(this.id, this.port, downloadPathOverride || this.downloadPath, url, this._extensions);
  var client = this;
